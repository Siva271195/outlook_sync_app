...
CUSTOMER_A_INTERVAL = 5   
CUSTOMER_A_BATCH_SIZE = 10
...
async def poll_customer_a():
    ...
    while True:
        try:
            ...
            # print(messages)
            if messages:
                print(f"\n=== CUSTOMER A - Found {len(messages)} messages ===")
...
async def main():
    ...
    print(f"Customer B: {CUSTOMER_B_INTERVAL}s interval, {CUSTOMER_B_BATCH_SIZE} records")
